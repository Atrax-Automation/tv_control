...
def selectpad():
    adb_command("input keyevent 23")
    print("Select pad")

def leftpad():
    adb_command("input keyevent 21")
    print("Left pad")

def rightpad():
    adb_command("input keyevent 22")
    print("Right pad")

def uppad():
    adb_command("input keyevent 19")
    print("Up pad")
...
def volumeup():
    adb_command("input keyevent 24")
    print("Volume Up")

def volumedown():
    adb_command("input keyevent 25")
    print("Volume Down")
